...
console.log("\n[map data] a map can CLEAR a building's ground texture, and empty means none");
{
  ...
  const farm = { id: "hhou", name: "Farm", isBuilding: true, uberSplat: "HSMA", abilities: [], heroAbilities: [], classification: [], properNames: [], animProps: [], attachAnimProps: [], attachLinkProps: [], upgradesUsed: [], tint: [1, 1, 1], targType: "structure", weapons: [] };
