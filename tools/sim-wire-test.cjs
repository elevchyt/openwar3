...
const base = () => ({
  ...
  isSummon: false, summonLeft: 0, summonMax: 0, raisedBy: "", timedLifeBuff: "", isIllusion: false, illusionOf: 0,
...
const hero = () => ({
  ...
  isSummon: true, summonLeft: 40.5, summonMax: 60, raisedBy: "AUan", timedLifeBuff: "", isIllusion: true, illusionOf: 1040,
