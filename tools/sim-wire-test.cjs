...
const base = () => ({
  ...
  swingSeq: 0, chopSeq: 0, swingBroken: false, swingSlam: false, altModel: false, altFormLeft: 0,
...
const hero = () => ({
  ...
  swingSeq: 17, chopSeq: 3, swingBroken: true, swingSlam: true, altModel: true, altFormLeft: 32.5,
