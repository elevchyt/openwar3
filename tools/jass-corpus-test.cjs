...
if (existsSync(warchasers)) {
  ...
  const base = {
    ...
    weapons: [], properNames: [], animProps: [], attachAnimProps: [], attachLinkProps: [], upgradesUsed: [], tint: [1, 1, 1], targType: 'ground',
  };
...
console.log('\n[7.8] Custom ability data (war3map.w3a → custom abilities)');
{
  ...
  if (existsSync(candy) && existsSync(abMetaPath)) {
    ...
    const baseAb = {
      ...
      missileArt: '', targetArt: '', casterArt: '', specialArt: '', effectArt: '', areaArt: '', buffArt: '', buffFx: [], animNames: [], lightning: [],
    };
