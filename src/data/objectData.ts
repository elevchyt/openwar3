...
export const UNIT_DEFERRED_FIELDS = ["uhpm", "umpm", "udef", "ua1b", "ua2b", "unam", "upro", "utip", "utpr", "uawt", "utub", "uhot"];
...
function applyMods(def: UnitDef, mods: Array<{ id: string; value: Val }>, trigStr: (v: string) => string): void {
  ...
  for (const m of mods) {
    switch (m.id) {
      ...
      case "uawt": def.awakenTip = trigStr(s(m.value)); continue; // Awakentip — and the TAVERN's
